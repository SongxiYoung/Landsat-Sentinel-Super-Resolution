...
def parse_args(input_args=None):
    ...
    parser.add_argument("--lambda_fft", type=float, default=1.0)
    parser.add_argument("--lambda_ndvi", type=float, default=1.0)
    ...
    parser.add_argument("--num_training_epochs", type=int, default=20)
